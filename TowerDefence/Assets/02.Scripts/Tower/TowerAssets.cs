...
public class TowerAssets : MonoBehaviour
{
    ...
    private static int towerUpgradeLevel;

    public static GameObject GetTowerPrefab(TowerType towerType, int towerLevel)
    {
        instance.towerPrefabs.Find(x => x.GetComponent<Tower>().info.type == towerType &&

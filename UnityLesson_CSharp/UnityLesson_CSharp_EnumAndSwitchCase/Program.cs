...
// 각 요소들이 동시에 일어나는 경우가 없는 상황에서 적합한 형태
...
[Flags] // ToString() 속성을 참조할때 중복되는 모든 요소들에 대해 표현이 가능(문자열로 항변환이 가능)
...
namespace UnityLesson_CSharp_EnumAndSwitchCase
{
    ...
    {
        static e_PlayerState createMotion = (e_PlayerState)438909348;
        static void Main(string[] args)
        {
            ...
            switch (createMotion)
            {
                ...
                case e_PlayerState.Home:
                    ...
                    break;
                default:
                    Console.WriteLine("전사는 그런 거 몰라요");
                    break;
            }
            Console.ReadLine();
        }
